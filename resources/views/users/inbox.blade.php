    ...
    <div class="container font-txt mb-4">
      ...
      @foreach ($messages as $message)
        <div class="border border-end-0 border-start-0 border-top-0 mb-3">
          <button data-bs-toggle="modal" data-bs-target="#messageModal-{{ $message->id }}" class="bg-transparent border-0">
            <div class="row">
              <div class="col-2">
                <div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="messageModal-{{ $message->id }}" tabindex="-1" aria-labelledby="messageModal-{{ $message->id }}Label" aria-hidden="true">
